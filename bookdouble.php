...
$dateDiff  = ceil(abs($end - $start) / 86400);
  ...
  $sql = "SELECT * FROM singlebed WHERE date='$fdate' and status=1 and type='double'";
...
$sql = "INSERT INTO fdoublebed (email,fdate,tdate,nop,status,sharing)
VALUES ('$user', '$fdate', '$tdate', '$nop', 1, '$share')";
if(mysqli_query($conn, $sql))
{ 
}		

$sql = "INSERT INTO singlebed (email,date,status,type)
VALUES ('$user', '$fdate', 1, 'double')";
         ...
         $mail->Mailer   = "smtp";
          ...
          $mail->AddAddress("$user");
           $mail->Subject = "Room booked";
            $mail->WordWrap   = 80;
             $content = "<b>you booked a room of double bed room  <br> number of persons is $nop <br>
